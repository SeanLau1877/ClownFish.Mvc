...
<body>
    <fieldset>
        ...
        <form action="/ajax/ns/TestFile/Download1.aspx" method="post">
            指定下载文件名：<input type="text" name="filename" value="中文汉字无乱码~!@#$%^&*()_+-=<>?|.txt" style="width: 300px" />
    ...
    <fieldset>
        ...
        <div>
            指定下载文件名：<input type="text" id="filename" value="中文汉字无乱码~!@#$%^&*()_+-=<>?|.txt" style="width: 300px" /><br />
